...
export class KeyboardControls extends React.Component<Prop, State> {
  ...
  public render() {
    ...
    return <div className="controls">
            <Control className={this.props.controlState.Left ? 'control_colored' : ''}>
            ...
            <Control className={this.props.controlState.Top? 'control_colored' : ''}>
            ...
            <Control className={this.props.controlState.Down? 'control_colored' : ''}>
            ...
            <Control className={this.props.controlState.Right? 'control_colored' : ''}>
